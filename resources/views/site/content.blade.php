    ...
    <section class="page_section team" id="team"><!--main-section team-start-->
        <div class="container">
            ...
            <div class="team_section clearfix">
                ...
                @foreach($people as $key => $man)

                    <div class="team_area">
                        <div class="team_box wow fadeInDown delay-0{{ $key * 3 + 3 }}s">
                            <div class="team_box_shadow"><a href="javascript:void(0)"></a></div>
                            <img src="{{ asset('assets/img/' . $man->images) }}" alt="{{ $man->name }}">
                            <ul>
                        ...
                        <h3 class="wow fadeInDown delay-0{{ $key * 3 + 3 }}s">{{ $man->name }}</h3>
                        <span class="wow fadeInDown delay-0{{ $key * 3 + 3 }}s">{{ $man->position }}</span>
                        <p class="wow fadeInDown delay-0{{ $key * 3 + 3 }}s">{{ $man->text }}</p>
                    </div>
